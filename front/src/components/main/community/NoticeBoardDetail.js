  ...
  return (
    <div className="notice_detail_div">
      ...
      <div className="notice_detail_btn_line">
        {isAuthor() && <button onClick={noticeDelete} className="notice_detail_delete">삭제</button>}
        <button onClick={handleNoticeClick} className="notice_detail_back">목록으로</button>
      </div>
    </div>
  );
}
