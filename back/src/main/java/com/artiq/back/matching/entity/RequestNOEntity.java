...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "art_request_no")
public class RequestNOEntity {
    // 의뢰 테이블
    ...
    @Column(length = 50, name = "re_field")
    ...
    @Column(length = 4000, name = "re_details")
    private String reDetails;

    @Column(length = 50, name = "ap_date")
    private LocalDate apDate;

    @Column(length = 4000, name = "ap_no_message")
    private String apNoMessage;

    @Column(length = 4000, name = "ap_ok_message")
